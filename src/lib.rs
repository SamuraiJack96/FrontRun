...
#[derive(Debug)]
pub struct FrontRunBotProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FrontRunBotProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FrontRunBot processing");
    
    let mut processor = FrontRunBotProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FrontRunBotProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FrontRunBotProcessor::new(false);
